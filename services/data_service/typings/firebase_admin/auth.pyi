...
def verify_id_token(id_token, app=..., check_revoked=...):
...
def verify_session_cookie(session_cookie, check_revoked=..., app=...):
...
def create_oidc_provider_config(
    provider_id, client_id, issuer, display_name=..., enabled=..., app=...
):
