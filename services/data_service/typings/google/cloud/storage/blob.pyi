...
class Blob(_PropertyMixin):
    ...
    def public_url(self):  # -> str:
        ...
        ...
    @classmethod
    def from_string(cls, uri, client=...):  # -> Self@Blob:
    ...
    def delete(
        ...
        retry: Optional[Union[Retry, ConditionalRetryPolicy]] = ...,
    ) -> None:
    ...
    def download_as_text(
        ...
        raw_download: Optional[bool] = ...,
        encoding: Optional[str] = ...,
        if_etag_match: Optional[Union[str, Set[str]]] = ...,
        if_etag_not_match: Optional[Union[str, Set[str]]] = ...,
        if_generation_match: Optional[int] = ...,
        if_generation_not_match: Optional[int] = ...,
        if_metageneration_match: Optional[int] = ...,
        if_metageneration_not_match: Optional[int] = ...,
    ...
    def rewrite(
        ...
        timeout=...,
        retry=...,
    ):  # -> tuple[None, int, int] | tuple[Unknown, int, int]:
    ...
    def owner(self):  # -> None:
        ...
        ...
    @property
    def retention_expiration_time(self):  # -> None:
