...
class LifecycleRuleConditions(dict):
    ...
    @classmethod
    def from_api_repr(cls, resource):  # -> Self@LifecycleRuleConditions:
    ...
    def days_since_custom_time(self):  # -> None:
        ...
        ...
    @property
    def custom_time_before(self):  # -> None:
    ...
    def days_since_noncurrent_time(self):  # -> None:
        ...
        ...
    @property
    def noncurrent_time_before(self):  # -> None:
...
class LifecycleRuleDelete(dict):
    ...
    @classmethod
    def from_api_repr(cls, resource):  # -> Self@LifecycleRuleDelete:
        """Factory:  construct instance from resource.
...
class LifecycleRuleSetStorageClass(dict):
    ...
    @classmethod
    def from_api_repr(cls, resource):  # -> Self@LifecycleRuleSetStorageClass:
        """Factory:  construct instance from resource.
...
class IAMConfiguration(dict):
    ...
    @classmethod
    def from_api_repr(cls, resource, bucket):  # -> Self@IAMConfiguration:
        """Factory:  construct instance from resource.
    ...
    @property
    def uniform_bucket_level_access_enabled(self):  # -> Any | bool:
    ...
    @property
    def uniform_bucket_level_access_locked_time(self):  # -> Any | None:
        ...
        ...
    @property
    def bucket_policy_only_enabled(self):  # -> Any | bool:
    ...
    @property
    def bucket_policy_only_locked_time(self):  # -> Any | None:
...
class Bucket(_PropertyMixin):
    ...
    def user_project(self):  # -> Unknown:
        ...
        ...
    @classmethod
    def from_string(cls, uri, client=...):  # -> Self@Bucket:
    ...
    @property
    def default_kms_key_name(self):  # -> None:
    ...
    def lifecycle_rules(
        self,
    ):  # -> Generator[LifecycleRuleDelete | LifecycleRuleSetStorageClass, None, None]:
    ...
    def project_number(self):  # -> int | None:
        ...
        ...
    @property
    def retention_policy_effective_time(self):  # -> None:
