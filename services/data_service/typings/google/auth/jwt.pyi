...
def decode(token, certs=..., verify=..., audience=..., clock_skew_in_seconds=...):
...
class OnDemandCredentials(
    ...
    def from_signing_credentials(
        ...
        ...
    def with_claims(
        self, issuer=..., subject=..., additional_claims=...
    ):  # -> Self@OnDemandCredentials:
        """Returns a copy of these credentials with modified claims.
    ...
    def valid(self):  # -> Literal[True]:
        ...
        """
        ...
    def refresh(self, request):  # -> NoReturn:
